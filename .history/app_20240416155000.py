...
def create_post():
    ...
    doc = {"name": name, "message": message, "brand": brand, "type_of_clothes": type_of_clothes, "size": size, "condition": condition, "image_url": image_url,"created_at": datetime.datetime.utcnow()}
